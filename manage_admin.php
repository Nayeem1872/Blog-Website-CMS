    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-2">
                <h1><i class="fas fa-blog"></i>Manage Admin</h1>
            </div>
        ...
        <div class="col-lg-12">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="table-primary"><?php echo $i["username"]; ?></td>
                    <td><?php echo $i["admin_name"]; ?></td>
                    <td><?php echo $i["addedby"]; ?></td>
                    
                  
                    
                   <td> <a href="DeleteAdmin.php?id=<?php echo $i["id"] ?>"><span class="btn btn-danger">delete</span></a>
                </td>
